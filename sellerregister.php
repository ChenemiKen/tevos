<?php
  ...
  if(isset($_POST['submit'])){
    ...
    if(empty($_POST['firstname'])||empty($_POST['lastname'])||empty($_POST['email'])||empty($_POST['shopname'])||empty($_POST['password1'])||empty($_POST['password2'])){
      ...
      $shop_name = $conn -> real_escape_string($_POST['shopname']);
      ...
      if(!($password1 === $password2)){
        ...
        $sql = "INSERT INTO sellers (firstname,lastname,email,shopname,`password`) VALUES('$first_name','$last_name','$email','$shop_name','$passwordHash')";
...
<main role="main" class="container">
    ...
    <h3 class="text-center mb-4 orange">Seller Registration</h3>
    <form action="" method="POST" class="g-3 col-md-8 offset-md-2" >
      ...
      <input type="text" name="shopname" class="form-control mb-4" placeholder="Shop Name" aria-label="shopname" required>
      <div class="row">
        <div class="col">
      ...
      <div class="text-center">
        <small>Already a seller? <a href="login.php" class="orange">Login</a></small>
      </div>
    </form>
</main>
